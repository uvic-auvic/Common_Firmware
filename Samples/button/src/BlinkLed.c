...
blink_led_init()
{
  ...
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP; //not needed
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; //not needed
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL; //not needed
