...
#include "SPI_DMA.h"
/* Private variables ---------------------------------------------------------*/
const uint8_t stringtosendwSPI1[] = "DMA SPI1"; /* Both strings have same length */
const uint8_t stringtosendwSPI2[] = "And SPI2"; /* Receive and transmit are done in the same transaction */
